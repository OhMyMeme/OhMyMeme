...
用法:
  python -m src.douyin_dl                    # 默认下载 10 个到 ~/Downloads/testD
  python -m src.douyin_dl --limit 5          # 下载 5 个
  python -m src.douyin_dl --out /tmp/emojis  # 自定义输出目录
  python -m src.douyin_dl --cookie "..."    # 命令行传入 Cookie
"""
